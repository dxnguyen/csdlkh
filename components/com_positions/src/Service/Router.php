...
namespace Positions\Component\Positions\Site\Service;
...
class Router extends RouterView
{
	...
	{
		$params = ComponentHelper::getParams('com_positions');
		$this->noIDs = (bool) $params->get('sef_ids');
		$this->categoryFactory = $categoryFactory;
		
		
			$positions = new RouterViewConfiguration('positions');
			$this->registerView($positions);
			$ccDetail = new RouterViewConfiguration('detail');
			$ccDetail->setKey('id')->setParent($positions);
