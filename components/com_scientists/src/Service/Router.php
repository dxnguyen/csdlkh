...
namespace Scientists\Component\Scientists\Site\Service;
...
class Router extends RouterView
{
	...
	{
		$params = ComponentHelper::getParams('com_scientists');
		$this->noIDs = (bool) $params->get('sef_ids');
		$this->categoryFactory = $categoryFactory;
		
		
			$scientists = new RouterViewConfiguration('scientists');
			$this->registerView($scientists);
			$ccDetail = new RouterViewConfiguration('detail');
			$ccDetail->setKey('id')->setParent($scientists);
