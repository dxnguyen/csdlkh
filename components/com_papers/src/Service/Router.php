...
namespace Papers\Component\Papers\Site\Service;
...
class Router extends RouterView
{
	...
	{
		$params = ComponentHelper::getParams('com_papers');
		$this->noIDs = (bool) $params->get('sef_ids');
		$this->categoryFactory = $categoryFactory;
		
		
			$papers = new RouterViewConfiguration('papers');
			$this->registerView($papers);
			$ccDetail = new RouterViewConfiguration('detail');
			$ccDetail->setKey('id')->setParent($papers);
