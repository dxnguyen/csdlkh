...
<form
	action="<?php echo Route::_('index.php?option=com_scientists&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_SCIENTISTS_FIELDSET_DETAIL'); ?></legend>
	...
	<?php if (Factory::getApplication()->getIdentity()->authorise('core.admin','scientists')) : ?>
