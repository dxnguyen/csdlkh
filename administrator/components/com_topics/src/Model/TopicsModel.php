...
class TopicsModel extends ListModel
{
	...
	*/
	...
	protected function getListQuery()
	{
		...
		if ($filter_department_id !== null && !empty($filter_department_id))
		{
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem)
		{
			...
			if (isset($oneItem->department_id))
			{
				$values    = explode(',', $oneItem->department_id);
				$textValue = array();
				...
				$oneItem->department_id = !empty($textValue) ? implode(', ', $textValue) : $oneItem->department_id;
			}
		}
