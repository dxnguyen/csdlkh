...
namespace Departments\Component\Departments\Administrator\View\Detail;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_DEPARTMENTS_TITLE_DETAIL'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_departments.detail', $this->item->id);
		}
